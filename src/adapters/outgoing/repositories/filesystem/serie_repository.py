...
def _clean_unicode(text: str) -> str:
    ...
    Nota: Se usa una lista de tuplas en vez de dict porque los surrogates
    colisionan en hash en Python, provocando falsos positivos de claves duplicadas.
    """
    if not text:
        return text

    # Lista de tuplas (surrogate, char) - evitar dict por colisión de hash
    replacements = [
        ('\udce1', 'á'),
        ('\udce9', 'é'),
        ('\udced', 'í'),
    ...
    for surrogate, char in replacements:
