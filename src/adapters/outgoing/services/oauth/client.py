...
class OAuth2Client:
    ...
    def exchange_code_for_token(self, code: str, code_verifier: str) -> Tuple[bool, Dict]:
        ...
        for base_url in urls_to_try:
            ...
            logger.info("[OAUTH_TOKEN_EXCHANGE] Authorization header: (hidden)")
            ...
            try:
                logger.info("[OAUTH_TOKEN_EXCHANGE] Haciendo petición POST...")
                ...
                if response.status_code == 200:
                    ...
                    logger.info("[OAUTH_TOKEN_EXCHANGE] Token obtenido exitosamente")
                    return True, data
                else:
    ...
    def introspect_token(self, token: str = None) -> Optional[Dict]:
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                logger.info("[OAUTH_INTROSPECT] Token introspection completed")
                return data
            return None
        except Exception as e:
