...
class OMDBMetadataService(IMetadataService):
    ...
    def get_movie_metadata(
        ...
        params = {"t": title, "type": "movie", "plot": "full", "r": "json"}
    ...
    def get_serie_metadata(self, serie_name: str) -> Optional[Dict]:
        ...
        params = {"t": serie_name, "type": "series", "plot": "full", "r": "json"}

        return self._make_request(params)

    def search_movies(self, query: str, year: int = None) -> List[Dict]:
        """Busca películas por título"""
        params = {"s": query, "type": "movie", "r": "json"}
    ...
    def search_series(self, query: str, year: int = None) -> List[Dict]:
        ...
        params = {"s": query, "type": "series", "r": "json"}
